    ...
    <section className="py-12 md:py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 md:mb-16">
          <span className="inline-block px-4 py-1.5 bg-emerald-100 text-emerald-800 text-xs sm:text-sm font-medium rounded-full mb-4 md:mb-6 tracking-wide">
              ...
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-8">
                <div className="lg:w-48 flex-shrink-0">
                  <div className="flex items-center gap-3">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-emerald-600 to-teal-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg
          ...
          <div className="group relative bg-white rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100">
            ...
            <div className="relative p-6 sm:p-8 lg:p-10">
              <div className="flex flex-col lg:flex-row lg:items-start gap-6 lg:gap-8">
                ...
                <div className="lg:w-48 flex-shrink-0">
                  <div className="flex items-center gap-3">
                    <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-teal-600 to-emerald-500 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-300">
                      <svg
                        className="w-7 h-7 text-white"
                        fill="none"
                        viewBox="0 0 24 24"
                    ...
                    <div className="grid sm:grid-cols-2 gap-3">
                      {missionItems.map((item, idx) => (
                        ...
                        >
                          ...
                          <span className="text-gray-600 text-xs sm:text-sm leading-relaxed group-hover/item:text-gray-800 transition-colors">
                            {item}
                          </span>
                        </div>
                      ))}
        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={idx}
                className="group relative rounded-2xl p-5 sm:p-6 shadow-md hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-gray-200 overflow-hidden bg-white bg-center bg-cover"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div
                    className={`w-12 h-12 rounded-xl bg-gradient-to-br ${value.gradient} mb-4 flex items-center justify-center shadow-md group-hover:scale-110 transition-transform duration-300`}
                  >
                  ...
                  <h4 className="text-lg sm:text-xl font-bold text-gray-900 mb-2 group-hover:text-emerald-700 transition-colors">
                    {value.name}
                  </h4>
        ...
        <div className="mt-16 md:mt-20 text-center">
          <div className="inline-block max-w-4xl bg-gradient-to-r from-emerald-50 to-teal-50 rounded-2xl p-6 sm:p-8 border border-emerald-100">
