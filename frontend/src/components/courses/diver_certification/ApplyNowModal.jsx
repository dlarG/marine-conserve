...
const ApplyNowModal = ({
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${apiBaseUrl}/api/courses/apply`, {
        method: "POST",
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mt-6 flex gap-3 justify-end">
              ...
              <button
                type="submit"
                disabled={!canSubmit}
                className="px-6 py-2.5 rounded-xl bg-gradient-to-r from-teal-600 to-green-600 text-white font-extrabold tracking-wide shadow hover:shadow-lg transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
