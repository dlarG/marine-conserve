    ...
    <header className="relative w-full h-[50vh] min-h-[260px] overflow-hidden bg-gray-900">
      ...
      <div
        ...
        style={{
          ...
          animation: "contactHeroShimmer 1.2s linear infinite",
        }}
        aria-hidden="true"
      />
...
const ContactHero = ({
  title = "Contact Us",
  subtitle = "We would love to hear from you. Reach out with questions, ideas, or partnership opportunities.",
  ...
  if (!shouldShowContent) return <ContactHeroSkeleton />;
