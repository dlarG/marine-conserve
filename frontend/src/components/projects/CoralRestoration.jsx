    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section id="hero" className="relative overflow-hidden">
        <div
          ...
          className={`relative h-[60vh] overflow-hidden transform transition-all duration-1000 ${
              ...
              <div>
                ...
                <div className="space-y-6 text-gray-700">
                  <p className="text-lg leading-relaxed">
                    ...
                    approach to reef rehabilitation in Sogod Bay, Southern
                    Leyte. We focus on collecting naturally detached coral
                    fragments from healthy donor colonies and nurturing them in
                    carefully maintained underwater nurseries.
                  </p>
                  <p className="text-lg leading-relaxed">
                    Through scientifically guided techniques including nursery
                    installation, coral fragment propagation, and long-term
                    monitoring, we aim to restore degraded reef areas and
                    enhance the resilience of existing coral communities.
                  </p>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Our systematic approach ensures the highest success rates in
                coral transplantation and long-term reef recovery
              </p>
            </div>
        ...
        >
          <div className="max-w-7xl mx-auto px-4">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Through continuous monitoring and scientific assessment, we
                track the success and long-term impact of our restoration
                efforts
              </p>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Trained over 50 local divers in coral restoration
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Collaborative research with marine biology institutions
                      for improved restoration methods
                    </p>
                  </div>
                </div>
